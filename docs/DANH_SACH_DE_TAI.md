...
9. Trợ Lý Sàng Lọc Hồ Sơ Tuyển Dụng & Hẹn Phỏng Vấn link dataset: [www.kaggle.com/datasets/snehaanbhawal/resume-dataset?select=data](https://www.kaggle.com/datasets/snehaanbhawal/resume-dataset?select=data)
