...
def run_react_agent(user_query: str, provider):
    ...
    while step < MAX_ITERATIONS:
        ...
        if step == 1:
            ...
            print(
                "🧠 Thought: Tôi đã có thông tin thời tiết Hà Nội, giờ tôi có thể tư vấn trang phục."
            )
            print(
...
if __name__ == "__main__":
    ...
    print("--- CHẠY CHATBOT BASELINE TRÊN 5 TEST CASES ---")
    ...
    for test in tests:
        ...
        run_baseline_chatbot(user_query=test["question"], provider=provider)
